...
public class NewFan {
    ...
    public NewFan(int speed, boolean on, double radius, String color) {
        this.speed = speed;
        this.on = on;
        this.radius = radius;
        this.color = color;
    ...
    System.out.println("Fan status: " + fan_status);
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // below is the new array that takes the fan instances without using toString()
        ArrayList<Fan> fans = new ArrayList<>();
        fans.add(new Fan(Fan.FAST, true, 10.5, "blue"));
        fans.add(new Fan(Fan.MEDIUM, false, 7.0, "red"));
        fans.add(new Fan());
